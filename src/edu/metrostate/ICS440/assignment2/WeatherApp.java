...
public class WeatherApp {
	...
	/************************************************************************************************************
	 * This method will print the user-defined input parameters.
	 * 
	 * @postcondition
	 *   The user-defined search parameters are displayed.
	 */
	...
	private static void addFutures() {
		...
		for (File file : weatherFiles) {
			...
			// Invoke the processor's call() method to begin processing the file.
	...
	private static void addFinalFutures() {
		...
		for (int futureNumber = 1; futureNumber <= Constants.FINAL_FUTURES; futureNumber++) {
			...
			// Invoke the finalProcessor's call() method to begin processing the splitQueue.
	 ...
	 * When complete, a new list is created representing the top (or bottom) search results from each individual
	 * Future's return.
	 * <p>
	 * 
	 * @postcondition
	...
	/************************************************************************************************************
	 * This method processes and analyzes the list generated by the first-pass search. It splits the list into
	 * four sub-lists and processes each list with its own Callable/Future (e.g. - 4 Futures total for this).
	 * This is the second pass of the overall search.
	 * <p>
	 * 
	 * @postcondition
	 *   An second search pass has transpired using the top results from the first search pass. A new list is
